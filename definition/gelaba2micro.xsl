...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="gml:definitions">
	...
	<xsl:apply-templates select="gml:definition[gml:property[@name='cercle'][@value='1']]" />
      </div>
      <div class="gmlGroup">
	<h2>Éléments facultatifs (cercle 2)</h2>
	<xsl:apply-templates select="gml:definition[gml:property[@name='cercle'][@value='2']]" />
      </div>
      <div class="gmlGroup">
	<h2>Types de données basiques et structurants</h2>
	<xsl:apply-templates select="gml:definition[not(gml:property[@name='cercle'])]" />
	<xsl:apply-templates select="gml:definition[gml:property[@name='cercle'][@value='0']]" />
      </div>
